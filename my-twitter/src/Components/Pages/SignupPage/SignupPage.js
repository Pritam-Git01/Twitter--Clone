...
function SignUp() {
  ...
  const handleNxt = (e) => {
    ...
    if (
      ...
      alert(
        "Please enter a valid password that must be at least 8 characters long and contain at least one uppercase, one lowercase, one digit and one special character."
      );
      return;
    }
    ...
    if (localStorage.data) {
      ...
      const dummynotes = [
        ...fake,
        { name1: username, email1: email, number1: phone, password1: password },
      ];
            ...
            <div className={style.signupPage}>
              ...
              {showPhone ? (
                <div>
                  ...
                  />
                  <span className={style.instead} onClick={handleShowPhone}>
                    Use email instead
                  </span>
                </div>
              ) : (
